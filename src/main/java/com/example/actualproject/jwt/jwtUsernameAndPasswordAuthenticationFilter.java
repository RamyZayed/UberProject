...
public class jwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            Authentication authenticate = authenticationManager.authenticate(authentication);// checks if the username exist and if it does it checks for the password if it is correct.
            return authenticate;
        }catch (IOException e){
    ...
    protected void successfulAuthentication(HttpServletRequest request,
      ...
      //  String key = "securesecuresecuresecuresecuresecuresecuresecuresecuresecuresecuresecure";
        ...
        String token = Jwts.builder()
                ...
                .claim("authorities", authResult.getAuthorities()) // this is for the body
